...
module.exports = async (req, res) => {
    ...
    // Deceptively return 200 OK to bots to avoid signaling detection
    if (parsedBody.middleName || parsedBody.MiddleName) {
        console.warn(`Honeypot triggered from IP: ${clientIp}. Field: ${parsedBody.middleName || parsedBody.MiddleName}`);
