...
## 2025-05-16 - [Seat Selection Interactivity]
**Learning:** Increasing hit targets by making entire rows clickable to focus inputs, combined with persistent visual "selected" states, makes selection-heavy forms feel much more robust and easier to navigate on both desktop and touch.
**Action:** Always look for opportunities to expand interactive areas and provide clear visual persistence for active selections.
